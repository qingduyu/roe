...
class Menus(models.Model):
    ...
    menu1=models.CharField(max_length=32,verbose_name=u'一级菜单的属性',blank=True,help_text='顶级菜单有个data-menu 属性，以及菜单要写他')
    parent=models.ForeignKey('self',verbose_name='父级菜单',null=True,blank=True,default=0,help_text=u'如果添加的是子菜单，请选择父菜单')
    # children=models.Many('self',verbose_name='子菜单',null=True,blank=True,default=0,help_text=u"如果有子菜单，就选择子菜单")
