...
from MysqlOps.models import MysqlFastSQL
from MysqlOps.serializers import MysqlfastSQLSerializer
...
class MyfastSQLAPI(APIView):
    ...
    def get_object(self, id):
        try:
            return MysqlFastSQL.objects.get(id=id)
        except MysqlFastSQL.DoesNotExist:
            raise Http404

    def get(self, request, format=None):

            queryset = MysqlFastSQL.objects.all().order_by("id")
            ...
            s = MysqlfastSQLSerializer(instance=page_data, many=True)  # 序列花这个分页数据
    ...
    def post(self, request, format=None):
        ...
        s = MysqlfastSQLSerializer(data=request.data)
        try:
    ...
    def put(self, request, format=None):
        try:
            ...
            s = MysqlfastSQLSerializer(DATA_MODEL, data=request.data)
        ...
        try:
            ...
            try:
                for i in data_id:
                    ...
                    # else:
                    MysqlFastSQL.objects.filter(id=i).delete()
