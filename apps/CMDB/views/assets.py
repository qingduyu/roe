...
def assets_config(request):
    return render(request, 'cmdb/assets/assets_config.html', {"user": request.user, "baseAssets": getBaseAssets()}, )
...
def assets_add(request):
    if request.method == "GET":
        ...
        return render(request, 'cmdb/assets/assets_add.html',
                      {"user": request.user, "baseAssets": getBaseAssets(), 'userList': userList})
...
def assets_list(request):
    ...
    return render(request, 'cmdb/assets/assets_list.html', {"user": request.user, "totalAssets": assetsList.count(),
...
def assets_view(request, aid):
    ...
    if assets.assets_type in ['server', 'vmser']:
        ...
        try:
            ...
            return render(request, 'cmdb/assets/assets_view.html', {"user": request.user},
                          )
        return render(request, 'cmdb/assets/assets_view.html', {"user": request.user, "asset_type": assets.assets_type,
...
def assets_modf(request, aid):
    try:
        ...
        return render(request, 'cmdb/assets/assets_modf.html', {"user": request.user},
                      )
    if assets.assets_type in ['server', 'vmser']:
        try:
            asset_ram = assets.ram_assets_set.all()
        ...
        return render(request, 'cmdb/assets/assets_modf.html', {"user": request.user, "asset_type": assets.assets_type,
                                                           "asset_main": assets, "asset_body": asset_body,
                                                           "asset_ram": asset_ram, "asset_disk": asset_disk,
...
def assets_search(request):
    ...
    if request.method == "GET":
        ...
        return render(request, 'cmdb/assets/assets_search.html', {"user": request.user, "baseAssets": getBaseAssets(),
...
def assets_log(request, page):
    if request.method == "GET":
        ...
        return render(request, 'cmdb/assets/assets_log.html', {"user": request.user, "assetsList": assetsList})
...
def assets_groups(request, id):
    try:
        ...
        return render(request, 'cmdb/assets/assets_groups.html', {"user": request.user, "errorInfo": "项目不存在"})
    ...
    return render(request, 'cmdb/assets/assets_groups.html', {"user": request.user, "project": project,
