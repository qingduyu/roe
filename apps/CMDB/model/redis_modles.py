...
class redistCluster(models.Model):
    ...
    tree_id=models.ManyToManyField(YewuTree,verbose_name=u"所属产品线", on_delete=models.SET_NULL, null=True, blank=True)
...
class DBUser(models.Model):
    ...
    operator = models.ManyToManyField(User, verbose_name="可操作的人", blank=True)
    def __unicode__(self):
        return self.db_user
