layui.define(["larryms", "larryElem"], function (e) {
    var u = layui.$, h = layui.larryElem, y = layui.larryms, g = layui.layer, t = "larryTab", b = {}, v = 0,
        a = new Array, r = function () {
            this.config = {
                data: undefined,
                url: undefined,
                type: "POST",
                ...
                isPageEffect: true
            }, this.larrymsCache = {navHtml: undefined, tab: undefined}
        }, n = function () {
            u("body").on("selectstart", function () {
                return false
            });
            ...
            u("#larryms_refresh").off("click").on("click", function () {
                ...
                if (u(this).hasClass("refreshThen")) {
                    ...
                    u("#larry_tab_content").children(".layui-show").css({
                        ...
                        "margin-left": "80px",
                        "margin-top": "60px"
                    }).delay(100).animate({opacity: "1", marginLeft: "0", marginTop: "0"}, 100);
                    setTimeout(function () {
            ...
            larryMenuClick: function () {
                var e = "#larryms_top_menu", t = u(e).find("li.larryms-this").children("a").data("group");
                var a = t !== undefined ? t : "0";
                d.on("click(LarrySide)", a, function (e) {
                    d.tabAdd(e.field)
                })
            }
        };
    ...
    r.prototype.menu = function () {
        ...
        if (e.data !== undefined && typeof e.data === "object") {
            ...
            if (e.url !== undefined) {
                var t = u.ajax({
                    type: e.type, url: e.url, async: false, dataType: "json", success: function (e, t, a) {
    ...
    r.prototype.larryCompleteMenu = function (e) {
        var t = this, a = t.config, r = y.elemCheck(a.top_menu, "top_menu"), i = y.elemCheck(a.left_menu, "left_menu");
        if (i !== "error" && a.top_menu !== false) {
            if (r != "undefined") {
                var n = o(e, "on");
                layui.data("larry_menu", {key: "navHtml", value: n});
                r.html(n.top);
                i.html(n.left[0]);
                a.top_menu = r;
                a.left_menu = i
    ...
    r.prototype.on = function (e, t, s) {
        var a = this, r = a.config, i = y.eventsCheck(e), d = t !== undefined ? t : "0";
        ...
        if (i.eventName === "click" && i.filter === r.leftFilter) {
            ...
            n.each(function () {
                var l = u(this), e = l.find("dl"), t = l.find(".grandson");
                if (r.spreadOne) {
                    l.on("click", function () {
                ...
                if (e.length > 0) {
                    e.children("dd").each(function () {
                        ...
                        u(this).on("click", function () {
                            if (!l.hasClass("grandson")) {
                                var e = u(this).children("a"), t = e.data("id"), a = e.data("url"),
                                    r = e.children("i:first").data("font"), i = e.children("i:first").data("icon"),
                                    n = e.children("cite").text(), o = {
                                        elem: e,
                                        field: {id: t, href: a, font: r, icon: i, title: n, group: d, addType: "nav"}
                                    };
                                s(o)
                            }
                        })
                    ...
                    l.on("click", function () {
                        var e = l.children("a"), t = e.data("id"), a = e.data("url"),
                            r = e.children("i:first").data("font"), i = e.children("i:first").data("icon"),
                            n = e.children("cite").text(), o = {
                                elem: e,
                                field: {id: t, href: a, font: r, icon: i, title: n, group: d, addType: "nav"}
    ...
    r.prototype.exists = function (l, s, d, f) {
        var p = -1, e = b.titleBox === undefined ? this.tabInit() : this;
        b.titleBox.find("li").each(function (e, t) {
            var a = u(this).children("cite"), r = u(this).data("id"), i = u(this).attr("id"), n = u(this).data("url"),
    ...
    r.prototype.getTabId = function (n, o, l) {
        var s = -1, e = b.titleBox === undefined ? this.tabInit() : this;
        b.titleBox.find("li").each(function (e, t) {
            var a = u(this).data("id"), r = u(this).data("url"), i = u(this).children("cite");
            if (l !== undefined) {
                if (o !== undefined) {
                    if (a === o) {
                        if (i.text() === n) {
    ...
    r.prototype.tabAdd = function (r) {
        var e = this, n = e.config, t = "", a = "", o = r.addType === undefined ? "nav" : r.addType;
        ...
        if (l === -1) {
            ...
            var g = e.getTabId(r.title, r.id, r.href), m = b.contentBox.find("iframe[lay-id='" + g + "']");
            m.attr("src", r.href);
            if (e.getNavTab(r.id, r.group)) {
                e.tabChange(g)
            } else {
    ...
    r.prototype.getNavTab = function (i, e) {
        var t = this, a = u(t.config.top_menu), n = false;
        ...
        var r = u(t.config.left_menu), o = r.find("a");
        u.each(o, function (e, t) {
            var a = u(t).data("id"), r = u(".larryms-nav-tree");
            if (a !== undefined && a === i) {
    ...
    r.prototype.tabChange = function (i, e, t, a) {
        var r = this, e = e || "off", t = t || "navNone", a = a || false;
        ...
        if (e === "on") {
            if (t === "nav") {
                var n = u(r.config.top_menu), o = u('#larry_tab_title li[lay-id="' + i + '"]'), l = o.data("id"),
                    s = o.data("group");
                if (s < n.children("li").length) {
                    n.children("li").eq(s).click()
                }
                var d = u(r.config.left_menu), f = d.find("a");
                if (l !== "larryms_home") {
    ...
    r.prototype.tabChangeBefore = function (e, t) {
        var a = this, t = t || Math.ceil(Math.random() * 67), r = b.contentBox.children(".layui-show")
    };
    ...
    r.prototype.pageEffect = function (e, t) {
        ...
        if (a.config.isPageEffect == true) {
            var t = t || Math.ceil(Math.random() * 67), r = b.contentBox.children(".layui-show");
            var i = s(t);
    ...
    r.prototype.tabAuto = function (c) {
        ...
        u("#larryms_title").each(function () {
            var l = u(this), s = l.children(".larryms-tab-title"), d = s.find(".layui-this"),
                e = s.children("#larryms_home"), f = l.find(".larryms-btn-default"), p = 0;
            s.find("li").each(function (e, t) {
                p += parseInt(u(t).outerWidth(true))
            });
            if (!s.find("li")[0]) return;
            u(window).off("resize").on("resize", function () {
                var t = parseInt(l.outerWidth(true) - 264), a = parseInt(d.outerWidth(true)),
                    e = parseInt(d.position().left + 1), r = parseInt(s.css("marginLeft")), i = e + r, n = t - p;
                if (p > t) {
                    f.removeClass("hide");
                ...
                u(".larryms-btn-default").off("click").on("click", function () {
                    if (p > t) {
                        var e = parseInt(s.css("marginLeft"));
                        if (u(this).attr("id") === "goLeft") {
                            if (Math.abs(e) !== 0) {
                                if (e + t < 0) {
                                    s.css({marginLeft: e + t})
                                } else {
                                    s.css({marginLeft: 0})
                                }
                            } else {
                                g.tips("已滚动到最左侧了", u(this), {tips: [1, "#FF5722"]})
                            }
                        }
                        if (u(this).attr("id") === "goRight") {
                            if (Math.abs(e) !== p - t) {
                                if (Math.abs(e) + t >= p - a) {
                                    s.css({marginLeft: t - p})
                                } else {
                                    s.css({marginLeft: e - t / 2})
                                }
                            } else {
                                g.tips("已滚动到最右侧了", u(this), {tips: [1, "#FF5722"]})
                            }
                        }
                    }
                })
    ...
    r.prototype.tabCtrl = function (e) {
        var a = this, t = a.config, r = a.getCurrentTabId();
        switch (e) {
            case"positionCurrent":
                var i = u(t.tab_elem).find("ul.layui-tab-title").children("li.layui-this"),
                    ...
                    o = i.children("i:first").data("font"), l = i.children("i:first").data("icon"), s = i.data("group"),
                    d = i.data("id"),
                    f = {title: i.children("cite").text(), href: n, font: o, icon: l, group: s, id: d};
                a.tabAdd(f);
                a.tabAuto(0);
                break;
            case"closeCurrent":
                ...
                break;
            case"closeOther":
                var p = u(t.tab_elem).find("ul.layui-tab-title").children("li"), c = p.length;
                if (c > 2) {
                    p.each(function () {
                        var e = u(this), t = e.attr("lay-id");
            ...
            case"closeAll":
                ...
                break;
            case"refreshAdmin":
                y.confirm("您确定要重新加载系统吗！", function () {
                    location.reload()
                }, function () {
                    return
                });
    ...
    r.prototype.render = function () {
        var o = this, a = o.config, e = a.top_menu !== undefined ? a.top_menu : "#larryms_top_menu",
            r = a.left_menu !== undefined ? a.left_menu : "#larryms_left_menu";
        if (a.top_menu !== undefined) {
            u(e).on("click", "li", function () {
                var e = u(this), t = e.children("a").data("group");
        ...
        u("#larry_tab").on("click", "#larry_tab_title li", function () {
            var e = u(this).attr("lay-id"), t = u(this).data("flag");
            o.tabChange(e, "on", t)
        });
        ...
        u("#larry_tab").on("click", "#larry_tab_title li i.layui-tab-close", function () {
            if (a.closed) {
