layui.define(["jquery", "larryms"], function (t) {
    var a = layui.$, e = layui.larryms;
    var o = function () {
    };
    ...
    o.prototype.json = function (t, e, o, n) {
        var r = this, i = typeof e === "function";
        if (i) {
            n = o;
            o = e;
            e = {}
        ...
        n = n || {};
        return a.ajax({
            type: n.type || "post", dataType: n.dataType || "json", data: e, url: t, success: function (t) {
                if (t.code == 200) {
                    o && o(t)
                } else if (t.code === 0) {
                    o && o(t)
                    ...
                    layer.msg(t.msg || t.code, {shift: 6});
                    n.error && n.error()
                }
            }, error: function (t) {
